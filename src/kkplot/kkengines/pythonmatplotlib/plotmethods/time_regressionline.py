...
def kkplot_pythonmatplotlib_time_regressionline( self, _id, _graph, _axes_index, _columns, _auxialiary_columns, **_kwargs) :
    ...
    self.W.iappendnl( 1, 'lower_limit = min( _axes.get_xlim()[0], _axes.get_ylim()[0])')
    self.W.iappendnl( 1, '_axes.plot([lower_limit,upper_limit],[lower_limit,upper_limit], color="grey", linestyle="dashed")')
