...
from kkplot.kkengines.pythonbokeh.plotmethods import kkplot_pythonbokeh_time_line
def kkplot_pythonbokeh_time_bars( self, _id, _graph, _axes_index, _columns, _auxialiary_columns, **_kwargs) :
